...
description: >-
  ...
  says "/planner", "plan the queue", "drain needs:plan", or runs a standing Planner
  session for a repo.
---
...
> [/start-feature](../start-feature/SKILL.md) (issue/board/worktree setup; chip-flow Plan
> phase defers here), chips execute, [/night-shift](../night-shift/SKILL.md) consumes
