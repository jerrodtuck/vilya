...
are shared everywhere; the examples speak this stack's language). Siblings: `vilya-crucible-blazor`,
`vilya-crucible-nextjs`, `vilya-crucible-fastapi`, `vilya-crucible-ml`. The dialect canon here is the **HackSoft
