...
| **Crucible variant** | \`vl-crucible-blazor\` | the review skill |
...
| **Crucible variant** | \`vl-crucible-nextjs\` | the review skill |
...
describe("parseConfig", () => {
  ...
  it("extracts repo config, status ids, native fields, and areas", () => {
    ...
    expect(cfg.crucibleVariant).toBe("vl-crucible-blazor");
  ...
  it("extracts full config from the slim config-only format", () => {
    ...
    expect(cfg.crucibleVariant).toBe("vl-crucible-nextjs");
