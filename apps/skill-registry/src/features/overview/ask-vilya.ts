...
3. New work, intent unchanged and already clear (tweaks, polish, bugs) → issue on the board (/update-docs routing) → Orchestrator dispatches (daytime may skip Planner).
