...
// map. Content model mirrors docs/specs/planner-flow.md + the /vl-plan skill:
...
export const NODES: Record<string, FlowNode> = {
  ...
  RECALL: {
    ...
    <li>Correct misunderstandings of the goal here, before execute starts.</li>
    <li>Treat aspirational &quot;already shipped / X exists&quot; claims as defects — correct them in the kickoff; check referenced issue <b>status at write time</b> before restating.</li></ul>`,
  },
  WRITE: {
