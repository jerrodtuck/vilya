...
export const NODE_GEOMS: NodeGeom[] = [
  ...
  { id: "START", x: 198, y: 122, w: 145, h: 56, rx: 13, title: "/start-feature", role: "issue · branch · consult", dot: true },
  ...
  { id: "DOCS", x: 391, y: 286, w: 140, h: 52, rx: 12, title: "/update-docs", role: "where does this go?" },
