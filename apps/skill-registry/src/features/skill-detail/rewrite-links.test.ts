...
describe("rewriteSkillLinks", () => {
  it("rewrites sibling SKILL.md links to detail pages", () => {
    const html = '<a href="../finish-feature/SKILL.md">/finish-feature</a>';
    expect(rewriteSkillLinks(html)).toBe(
      '<a href="/skills/finish-feature">/finish-feature</a>'
    );
  });

  it("rewrites multiple links in one body", () => {
    const html =
      '<a href="../start-feature/SKILL.md">a</a> and <a href="../night-shift/SKILL.md">b</a>';
    const out = rewriteSkillLinks(html);
    expect(out).toContain('href="/skills/start-feature"');
    expect(out).toContain('href="/skills/night-shift"');
  });

  it("leaves absolute and non-skill links alone", () => {
    const html =
      '<a href="https://example.com/SKILL.md">x</a> <a href="../../docs/project-tracking/GITHUB-PROJECTS.md">y</a> <a href="/skills/history">z</a>';
